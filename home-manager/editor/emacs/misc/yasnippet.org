...
#+end_src
*** blog-devto
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/blog-devto") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: blog-devto
  # key: blog-devto
  # --
...
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/blog-hugo") :mkdirp yes :noweb yes
  ...
  ,#+HUGO_BASE_DIR: ../../
  ,#+HUGO_CATEGORIES: ${3:$$(yas-choose-value '("diary" "fleeting" "literature" "permanent" "poem" "structure"))}
...
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/diary-mtg-template-friday") :mkdirp yes :noweb yes
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 14:00] =>  0:30
  :END:
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 14:00] =>  0:30
  :END:
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 14:00] =>  0:30
  :END:
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 14:00] =>  0:30
  :END:
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 14:00] =>  0:30
  :END:
#+end_src
...
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/diary-mtg-template-saturday") :mkdirp yes :noweb yes
  ...
  # --
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 14:00] =>  0:30
  :END:
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
...
#+end_src
*** literature
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/literature") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: literature
  # key: literature
  # --
  ...
  - 出典: xxx
  - 著者: xxx
  - 参照日: `(format-time-string "%Y-%m-%d")`
  - 種別: ${4:$$(yas-choose-value '("書籍" "記事" "論文" "ブログ" "動画"))}
