  ...
  (add-hook 'after-init-hook
            #'(lambda ()
                (when (require 'doom-themes)
                  ...
                  ;; Emacs 31 makes gnus-group-news-low inherit from its
                  ;; empty variant; prevent themes from creating a cycle.
...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'doom-modeline
    ...
    (doom-modeline-def-modeline 'main
      ...
      '(compilation objed-state misc-info project-name persp-name battery grip irc mu4e gnus github debug repl lsp my/nskk minor-modes input-method indent-info buffer-encoding major-mode process vcs check time))
