...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'elfeed-org
    ;; config
    (setopt rmh-elfeed-org-files '("~/ghq/github.com/takeokunn/private/project/elfeed.org"))
...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'citar
    ...
    (setopt citar-bibliography
            `,(list (concat (s-trim-right (shell-command-to-string "ghq root"))
                            "/github.com/takeokunn/blog/hugo/references.bib")))
