...
#+begin_src emacs-lisp :tangle yes
  ...
  (keymap-global-set "C-x C-g" #'my/magit-status)
...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'window
    (add-hook 'window-buffer-change-functions #'my/tab-bar-rename-tab))
#+end_src
** consult-projectile
#+begin_src emacs-lisp :tangle yes
...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'projectile-git-autofetch
    ...
    (setopt projectile-git-autofetch-fetch-args '("--no-progress" "--prune")))
#+end_src
* Window
** ace-window
#+begin_src emacs-lisp :tangle yes
...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'typescript-mode
    ;; hooks
    ;; (remove-hook 'typescript-mode-hook #'jest-minor-mode)
...
** aidermacs
#+begin_src emacs-lisp :tangle yes
  (autoload-if-found '(aidermacs-transient-menu) "aidermacs" nil t)

  (keymap-global-set "C-x C-/" #'aidermacs-transient-menu)

  (with-eval-after-load 'aidermacs
    (setopt aidermacs-extra-args '("--yes-always"))
    (setopt aidermacs-use-architect-mode t)
    (setopt aidermacs-auto-commits t)
    (setopt aidermacs-watch-files t)
    (setopt aidermacs-auto-accept-architect t))
