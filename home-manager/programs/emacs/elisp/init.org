...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'lsp-icons
    ;; config
    (setopt lsp-modeline-code-action-icons-enable nil))
...
#+begin_src emacs-lisp :tangle yes
  ...
  ")
    (setopt ellama-provider (progn
                              (make-llm-ollama :chat-model "gemma2:9b" :embedding-model "gemma2:9b"))))
#+end_src
* MyFunc
