...
#+end_src
** [linux] clipboardに入るようにする
:PROPERTIES:
:CUSTOM_ID: linux-clipboard
:END:
#+begin_src emacs-lisp :tangle yes
  (defun my/copy-from-wayland ()
    (shell-command-to-string "wl-paste -n"))

  (defun my/paste-to-wayland (text)
    (let ((process-connection-type nil))
  ...
  (when-linux-not-window-system
   (setq interprogram-cut-function #'my/paste-to-wayland)
   (setq interprogram-paste-function #'my/copy-from-wayland))
#+end_src
** native comp
:PROPERTIES:
