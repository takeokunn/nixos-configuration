...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'nskk
    ...
    (set-face-attribute 'nskk-cursor-hiragana nil :background "#ff79c6")
    (set-face-attribute 'nskk-cursor-katakana nil :background "#8be9fd")
    (set-face-attribute 'nskk-cursor-latin nil :background "#50fa7b")
    (set-face-attribute 'nskk-cursor-jisx0208-latin nil :background "#ffb86c")
    (set-face-attribute 'nskk-cursor-abbrev nil :background "#f1fa8c")
