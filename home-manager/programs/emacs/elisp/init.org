...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'lsp-javascript
    ...
    (setopt lsp-disabled-clients '(ts-ls))
...
:PROPERTIES:
:CUSTOM_ID: my-get-class-name-by-file-name
:END:
#+begin_src emacs-lisp :tangle yes
...
:PROPERTIES:
:CUSTOM_ID: my-current-ip-address
:END:
#+begin_src emacs-lisp :tangle yes
...
:PROPERTIES:
:CUSTOM_ID: my-copy-claude-file-to-private
:END:
#+begin_src emacs-lisp
...
:PROPERTIES:
:CUSTOM_ID: my-projectile-php-open-corresponding-test
:END:
#+begin_src emacs-lisp
