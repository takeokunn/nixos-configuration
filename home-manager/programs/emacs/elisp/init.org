...
#+begin_src emacs-lisp :tangle yes
  ...
  (keymap-global-set "M-L" #'syntax-subword-downcase)
  (keymap-global-set "C-L" #'syntax-subword-downcase)
...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'mu4e-folders
    ...
    (setopt mu4e-maildir-shortcuts '((:maildir "/Gmail/INBOX" :key ?i)
                                     ...
                                     (:maildir "/Gmail/RakutenSecurity" :key ?r))))
...
*** mu4e-dashboard
#+begin_src emacs-lisp :tangle yes
  (autoload-if-found '(mu4e-dashboard-mode) "mu4e-dashboard" nil t)
...
#+begin_src emacs-lisp :tangle yes
  ...
  (with-eval-after-load 'org-crypt
    ;; config
    (setq org-crypt-key "0B10DAA7BA0236D73822 87660F79C0AB03FD7A1C")
