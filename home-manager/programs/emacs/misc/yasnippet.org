...
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/diary") :mkdirp yes :noweb yes
  ...
  - OrderSync
    - 引続き対応する
  ,**** MTG
  - 10:30 AM-10:45 AM 在庫同期 朝会
  - 10:45 AM-11:00 AM IMS 朝会
  ,**** 困ってること・相談したいこと
  特になし
  ,**** 一言
#+end_src
...
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/diary-mtg-template-friday") :mkdirp yes :noweb yes
  ...
  # --
  ,** TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 在庫同期 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 10:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 10:45] =>  0:15
  :END:
  ,** TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 11:00] =>  0:15
  :END:
  ,** TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 在庫同期 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 10:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 10:45] =>  0:15
  :END:
  ,** TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 11:00] =>  0:15
  :END:
  ,** TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 在庫同期 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 10:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 10:45] =>  0:15
  :END:
  ,** TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 11:00] =>  0:15
  :END:
  ,** TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 11:00] =>  0:15
  :END:
  ,** TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 在庫同期 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 10:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 10:45] =>  0:15
  :END:
  ,** TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 11:00] =>  0:15
  :END:
...
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/diary-mtg-template-saturday") :mkdirp yes :noweb yes
  ...
  # --
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 2)))` 在庫同期 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 10:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 10:45] =>  0:15
  :END:
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 2)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 11:00] =>  0:15
  :END:
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 3)))` 在庫同期 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 10:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 10:45] =>  0:15
  :END:
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 3)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 11:00] =>  0:15
  :END:
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 4)))` 在庫同期 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 10:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 10:45] =>  0:15
  :END:
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 4)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 11:00] =>  0:15
  :END:
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 5)))` 在庫同期 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 10:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 10:45] =>  0:15
  :END:
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 5)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 11:00] =>  0:15
  :END:
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 6)))` 在庫同期 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 10:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 10:45] =>  0:15
  :END:
  ,** TODO `(format-time-string "%m-%d %a" (time-add (current-time) (days-to-time 6)))` IMS 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 10:45]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 11:00] =>  0:15
  :END:
