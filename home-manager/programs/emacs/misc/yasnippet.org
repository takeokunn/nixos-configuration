...
#+end_src
*** issue
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/markdown-mode/issue") :mkdirp yes :noweb yes
  # name: issue
  # key: issue
  # --
  # 背景
...
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/diary-mtg-template-friday") :mkdirp yes :noweb yes
  ...
  # --
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 13:35] =>  0:05
  :END:
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 13:35] =>  0:05
  :END:
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 13:35] =>  0:05
  :END:
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 13:35] =>  0:05
  :END:
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 13:35] =>  0:05
  :END:
#+end_src
...
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/diary-mtg-template-saturday") :mkdirp yes :noweb yes
  ...
  # --
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 13:35] =>  0:05
  :END:
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 13:35] =>  0:05
  :END:
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 13:35] =>  0:05
  :END:
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 13:35] =>  0:05
  :END:
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 朝会
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 13:30]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 13:35] =>  0:05
  :END:
#+end_src
*** diary-measure-template-friday
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/diary-measure-template-friday") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: diary-measure-template-friday
  # key: diary-measure-template-friday
  # --
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 18:00] =>  6:00
  :END:
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 18:00] =>  6:00
  :END:
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 18:00] =>  6:00
  :END:
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 18:00] =>  6:00
  :END:
  ,** TODO [#A] `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 18:00] =>  6:00
  :END:
#+end_src
*** diary-measure-template-saturday
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/diary-measure-template-saturday") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: diary-measure-template-saturday
  # key: diary-measure-template-saturday
  # --
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 18:00] =>  6:00
  :END:
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 18:00] =>  6:00
  :END:
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 18:00] =>  6:00
  :END:
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 18:00] =>  6:00
  :END:
  ,** [#A] TODO `(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 計測用
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 12:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 18:00] =>  6:00
  :END:
...
#+end_src
*** task-response
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/task-response") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: task-response
  # key: task-response
  # --
...
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/task-develop") :mkdirp yes :noweb yes
  ...
  ,*** TODO 要件を確認する
  ,*** TODO 修正する
  ,*** TODO pull requestを出す[0/2]
  ,**** TODO descriptionを埋める
  ,**** TODO QA項目を埋める
  ,*** TODO reviewを通す
  ,*** TODO QAを通してmergeする
  ,*** TODO redmineに記述する
...
#+end_src
*** task-review
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/task-review") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: task-review
  # key: task-review
  # --
...
#+end_src
*** task-blog
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/task-blog") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: task-blog
  # key: task-blog
  # --
...
#+end_src
*** nix-shell
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/nix-shell") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: nix-shell
  # key: nix-shell
  # --
  ...
  ,#+BEGIN_SRC nix :noweb yes
    { pkgs ? import <nixpkgs> { } }:
      pkgs.mkShell { buildInputs = with pkgs; [ $2 ]; }
  ,#+END_SRC

  ,#+begin_src shell :nix-shell $1-shell :results output
    $0
  ,#+end_src
#+end_src
*** fleeting
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/org-mode/fleeting") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: fleeting
  # key: fleeting
  # --
...
#+end_src
*** aaa
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/php-mode/aaa") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: aaa
  # key: aaa
  # --
...
#+end_src
*** phpunit-setup
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/php-mode/phpunit-setup") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: phpunit-setup
  # key: phpunit-setup
  # --
...
#+end_src
*** Deno.test
#+begin_src snippet :tangle (expand-file-name "~/.emacs.d/snippets/typescript-mode/deno-test") :mkdirp yes :noweb yes
  # -*- mode: snippet -*-
  # name: deno-test
  # key: deno-test
  # --
