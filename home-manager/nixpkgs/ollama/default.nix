...
let
  ...
  llamacppPatches = [
    ...
    (preparePatch "05-clip-fix.diff"
      "sha256-rCc3xNuJR11OkyiXuau8y46hb+KYk40ZqH1Llq+lqWc=")
  ];
  ...
  runtimeLibs = lib.optionals enableRocm [ rocmPath ]
