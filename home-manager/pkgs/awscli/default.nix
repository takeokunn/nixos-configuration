{ lib, python3, fetchPypi, groff, less, nix-update-script, testers, awscli }:

python3.pkgs.buildPythonApplication rec {
  pname = "awscli";
  version =
    "1.32.58"; # N.B: if you change this, change botocore and boto3 to a matching version too
  pyproject = true;
  ...
  pythonRelaxDeps = [ "botocore" "colorama" "docutils" "rsa" ];
