...
in
{
  "@github/copilot-language-server" = nodeEnv.buildNodePackage {
    ...
    version = "1.350.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@github/copilot-language-server/-/copilot-language-server-1.350.0.tgz";
      sha512 = "6c1e1Xw2FspR/oLoXENhQ8jc4qV7QqfwQ4pZcPAJrK1+O8iwlemxKzQ8qbqUGJSzuCwHp8cMStISbgYAjFUZeg==";
    };
    dependencies = [
