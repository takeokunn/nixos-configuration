...
}:
{
  ...
  emacs-consult-tramp = {
    ...
    version = "456728d98c334522cefbfe059480daf7516ea309";
    src = fetchFromGitHub {
      owner = "Ladicle";
      repo = "consult-tramp";
      rev = "456728d98c334522cefbfe059480daf7516ea309";
      fetchSubmodules = false;
      sha256 = "sha256-ZLzjHscapGGLbIpjy/WYa4O3uqKobmHBt+D7t1HumXs=";
    };
    date = "2026-01-10";
  };
  emacs-copilot = {
  ...
  emacs-llm = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.28.5";
      fetchSubmodules = false;
      sha256 = "sha256-WPxh0A+SubNegcQduPvXSGVuCSc7XrljWgE1DAtmm5E=";
    };
  };
  ...
  emacs-rainbow-csv = {
    ...
    version = "5b0bbaca8c6c1785b5ddd48fdf16817acc046ad2";
    src = fetchFromGitHub {
      owner = "emacs-vs";
      repo = "rainbow-csv";
      rev = "5b0bbaca8c6c1785b5ddd48fdf16817acc046ad2";
      fetchSubmodules = false;
      sha256 = "sha256-K2sSCOxqsNI0f4bPHQ9Mg3YF0GQDGoQWa9U8HKtcEJs=";
    };
    date = "2026-01-01";
  };
  emacs-sudden-death = {
  ...
  vimdoc-ja = {
    pname = "vimdoc-ja";
    version = "e114b397e62d1ff336a7b3b3c2b9e888d2eac46b";
    src = fetchFromGitHub {
      owner = "vim-jp";
      repo = "vimdoc-ja";
      rev = "e114b397e62d1ff336a7b3b3c2b9e888d2eac46b";
      fetchSubmodules = false;
      sha256 = "sha256-SGKklf+pJ7/QiACrBgjt2YP3Dz+BPMpeR31isDbFRcM=";
    };
    date = "2026-01-18";
  };
}
