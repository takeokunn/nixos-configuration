...
}:
{
  ...
  emacs-copilot-chat = {
    ...
    version = "17c4bfaafe7cd7da1b333714dfa548cd08a875d7";
    src = fetchFromGitHub {
      owner = "chep";
      repo = "copilot-chat.el";
      rev = "17c4bfaafe7cd7da1b333714dfa548cd08a875d7";
      fetchSubmodules = false;
      sha256 = "sha256-aN2GEV82yDyO94LRrsiyYOHPfNfdzpZMWyRj9I8u4QM=";
    };
    date = "2025-03-01";
  };
  emacs-direnv-mode = {
  ...
  emacs-llm = {
    pname = "emacs-llm";
    version = "74b609949dc973f757f67708e194eebee445f1c2";
    src = fetchFromGitHub {
      owner = "ahyatt";
      repo = "llm";
      rev = "74b609949dc973f757f67708e194eebee445f1c2";
      fetchSubmodules = false;
      sha256 = "sha256-8YRzFn4+vCSCuW1spb5Dd8JugHnxCGKWQbdJOFcmTH8=";
    };
    date = "2025-03-01";
  };
