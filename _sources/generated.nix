...
}:
{
  ...
  emacs-ox-typst = {
    ...
    version = "5c855902fe11c10292e495501e7f1b4adbb53d16";
    src = fetchFromGitHub {
      owner = "jmpunkt";
      repo = "ox-typst";
      rev = "5c855902fe11c10292e495501e7f1b4adbb53d16";
      fetchSubmodules = false;
      sha256 = "sha256-kxYQEjhNrF4LLVLETM8L3ffRlnzKzqUoL5WqLVZ+ivk=";
    };
    date = "2025-07-04";
  };
  emacs-php-doc-block = {
  ...
  vimdoc-ja = {
    pname = "vimdoc-ja";
    version = "6f87a0f07afa359422f35c568f038d9781a562e6";
    src = fetchFromGitHub {
      owner = "vim-jp";
      repo = "vimdoc-ja";
      rev = "6f87a0f07afa359422f35c568f038d9781a562e6";
      fetchSubmodules = false;
      sha256 = "sha256-noigsQksNO35gZs+a7abdlmvzM8RG7/w73FSsXUkRlc=";
    };
    date = "2025-09-12";
  };
}
