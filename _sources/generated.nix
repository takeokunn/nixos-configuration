...
}:
{
  ...
  emacs-ox-typst = {
    ...
    version = "a6f6759d269a102c2c18bf82d516568dcba895f9";
    src = fetchFromGitHub {
      owner = "jmpunkt";
      repo = "ox-typst";
      rev = "a6f6759d269a102c2c18bf82d516568dcba895f9";
      fetchSubmodules = false;
      sha256 = "sha256-8G7P2m+Im4pSSjnYs9+95C/ds2KrglY7+9Jzcphemgc=";
    };
    date = "2025-11-03";
  };
  emacs-php-doc-block = {
  ...
  emacs-rainbow-csv = {
    ...
    version = "c8d186282c9104a029e90cc78b09f4eee4b410f1";
    src = fetchFromGitHub {
      owner = "emacs-vs";
      repo = "rainbow-csv";
      rev = "c8d186282c9104a029e90cc78b09f4eee4b410f1";
      fetchSubmodules = false;
      sha256 = "sha256-vgNkZXvshn3R3ONFZn9w38/NEo6rPVtcwJaMXCjsf6s=";
    };
    date = "2025-11-09";
  };
  emacs-sudden-death = {
  ...
  vimdoc-ja = {
    pname = "vimdoc-ja";
    version = "2f7d73d037439871caf65d58d1df0caf1efa12b4";
    src = fetchFromGitHub {
      owner = "vim-jp";
      repo = "vimdoc-ja";
      rev = "2f7d73d037439871caf65d58d1df0caf1efa12b4";
      fetchSubmodules = false;
      sha256 = "sha256-TItU4Z/jtXcYUM2Db2GRNkpGxdEWP1dLQrSGHKpLXU4=";
    };
    date = "2025-11-09";
  };
}
