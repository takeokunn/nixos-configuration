...
}:
{
  ...
  emacs-copilot-chat = {
    ...
    version = "45d1ff3efee1cf35c40f5bcf5ae49ee3ad3beb37";
    src = fetchFromGitHub {
      owner = "chep";
      repo = "copilot-chat.el";
      rev = "45d1ff3efee1cf35c40f5bcf5ae49ee3ad3beb37";
      fetchSubmodules = false;
      sha256 = "sha256-9Sa0YwYZq2XTqV4AnbYe11RGkmwyzCCt6hUVl/bkjBU=";
    };
    date = "2025-01-25";
  };
  emacs-direnv-mode = {
  ...
  emacs-llm = {
    pname = "emacs-llm";
    version = "358bbaaf2cc65b2d775d75734c0fb15cc9f2c109";
    src = fetchFromGitHub {
      owner = "ahyatt";
      repo = "llm";
      rev = "358bbaaf2cc65b2d775d75734c0fb15cc9f2c109";
      fetchSubmodules = false;
      sha256 = "sha256-fMJKqEgyXbuYoIobwgZhI+0IqRVRWe4A8tINGXnWxpA=";
    };
    date = "2025-01-22";
  };
