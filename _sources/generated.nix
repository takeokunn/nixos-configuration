...
}:
{
  ...
  emacs-llm = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.27.2";
      fetchSubmodules = false;
      sha256 = "sha256-/v7lTLo0HSQcOW8nmT+Uaalov+WXZm9UxrEWrKp2GpY=";
    };
  };
  ...
  nvim-aibo = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.7.0";
      fetchSubmodules = false;
      sha256 = "sha256-f26LN+tvNlRU8HigFWqy7wbp+sB8NaxNNfJgkhlA0bI=";
    };
  };
  sublime-gleam = {
    pname = "sublime-gleam";
  ...
  vim-gin = {
    pname = "vim-gin";
    version = "4033d58fc86789c43a6247b8fb9417d821d94ec9";
    src = fetchFromGitHub {
      owner = "lambdalisue";
      repo = "vim-gin";
      rev = "4033d58fc86789c43a6247b8fb9417d821d94ec9";
      fetchSubmodules = false;
      sha256 = "sha256-EV7klC7sVgACZGH8t8T+RuzVT1pfKLd6UB9+/0Eqeiw=";
    };
    date = "2025-10-12";
  };
  vim-neco = {
  ...
  vimdoc-ja = {
    pname = "vimdoc-ja";
    version = "4003542d70fc10941ac3c2db4cc482c42ee1ee1f";
    src = fetchFromGitHub {
      owner = "vim-jp";
      repo = "vimdoc-ja";
      rev = "4003542d70fc10941ac3c2db4cc482c42ee1ee1f";
      fetchSubmodules = false;
      sha256 = "sha256-Wuq78zATuXfVo/8GCIaYvBQUnzqTOAJ3xjshZKe520o=";
    };
    date = "2025-10-13";
  };
}
