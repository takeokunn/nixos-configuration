...
}:
{
  ...
  emacs-llm = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.25.0";
      fetchSubmodules = false;
      sha256 = "sha256-0Phza0RpXF9ni7k8ZEgtqbULMFxRji3E4aGoYom8Ig4=";
    };
  };
  ...
  vim-fern = {
    pname = "vim-fern";
    version = "7a1a31a8a0103e9eefbdc63feec5b1ce7580a7a2";
    src = fetchFromGitHub {
      owner = "lambdalisue";
      repo = "vim-fern";
  ...
  vimdoc-ja = {
    pname = "vimdoc-ja";
    version = "83462375b97be697690ee1f62d21e1252cd16972";
    src = fetchFromGitHub {
      owner = "vim-jp";
      repo = "vimdoc-ja";
      rev = "83462375b97be697690ee1f62d21e1252cd16972";
      fetchSubmodules = false;
      sha256 = "sha256-IwwUeHx5txRnPy1S3LHR39OR+6dRpCeEBxvqtpzwmhg=";
    };
    date = "2025-04-29";
  };
}
