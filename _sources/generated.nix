...
}:
{
  ...
  emacs-llm = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.28.2";
      fetchSubmodules = false;
      sha256 = "sha256-auVcj9sOZpqtfXRkaK72e1QgKp/t3+K+vjX0OmgtASs=";
    };
  };
  ...
  vimdoc-ja = {
    pname = "vimdoc-ja";
    version = "71ffd0c85bf266fdaf71fbb588a258840c74a53e";
    src = fetchFromGitHub {
      owner = "vim-jp";
      repo = "vimdoc-ja";
      rev = "71ffd0c85bf266fdaf71fbb588a258840c74a53e";
      fetchSubmodules = false;
      sha256 = "sha256-s7zVzLoJy0jZlESehhw7q9c1MjGtkGXplumoBtIeBbM=";
    };
    date = "2025-12-21";
  };
}
