...
}:
{
  ...
  emacs-copilot = {
    pname = "emacs-copilot";
    version = "29bbb9d6341d0630d5c312306e8d5ae92dff6e75";
    src = fetchFromGitHub {
      owner = "copilot-emacs";
      repo = "copilot.el";
      rev = "29bbb9d6341d0630d5c312306e8d5ae92dff6e75";
      fetchSubmodules = false;
      sha256 = "sha256-Relc8Z/LneXJ4MDWTyohncHjvud+WQNWOcMhOleajcs=";
    };
    date = "2025-12-09";
  };
  emacs-direnv-mode = {
  ...
  vimdoc-ja = {
    pname = "vimdoc-ja";
    version = "4fd3ae0d71c9de34225743a1654f5a3e16080d28";
    src = fetchFromGitHub {
      owner = "vim-jp";
      repo = "vimdoc-ja";
      rev = "4fd3ae0d71c9de34225743a1654f5a3e16080d28";
      fetchSubmodules = false;
      sha256 = "sha256-0T+VAKX8kEbRe1gRsMf4sp0ptkD3g3hlzZKRFbPNHTE=";
    };
    date = "2025-12-05";
  };
}
