...
}:
{
  ...
  emacs-copilot-chat = {
    ...
    version = "39c0ec9752be430be3d68b7033d443e0510b97b8";
    src = fetchFromGitHub {
      owner = "chep";
      repo = "copilot-chat.el";
      rev = "39c0ec9752be430be3d68b7033d443e0510b97b8";
      fetchSubmodules = false;
      sha256 = "sha256-K1qNMU2gos7qaBRF9m3hqQ8zTe2F7pPmKBDiInAos4w=";
    };
    date = "2025-03-04";
  };
  emacs-direnv-mode = {
  ...
  emacs-llm = {
    pname = "emacs-llm";
    version = "ff677d88b33eb7ea5e3076046b5c0c5f7337a0fc";
    src = fetchFromGitHub {
      owner = "ahyatt";
      repo = "llm";
      rev = "ff677d88b33eb7ea5e3076046b5c0c5f7337a0fc";
      fetchSubmodules = false;
      sha256 = "sha256-9hAHhqW5ZHRi4xSECI8eBRHWFo0tugluCRjC8PfnVHw=";
    };
    date = "2025-03-03";
  };
