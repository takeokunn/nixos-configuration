...
}:
{
  ...
  emacs-ox-typst = {
    ...
    version = "5d574b78e9b06bea47422d57d827c38f30806b5d";
    src = fetchFromGitHub {
      owner = "jmpunkt";
      repo = "ox-typst";
      rev = "5d574b78e9b06bea47422d57d827c38f30806b5d";
      fetchSubmodules = false;
      sha256 = "sha256-gpH/jgdXYT5bp38v+Gb+ek4fHXEGgiEcgiLUcc/qZJU=";
    };
    date = "2025-06-19";
  };
  emacs-php-doc-block = {
  ...
  vimdoc-ja = {
    pname = "vimdoc-ja";
    version = "ffb4d0355e0da4f2781953b94217482521d3c9c3";
    src = fetchFromGitHub {
      owner = "vim-jp";
      repo = "vimdoc-ja";
      rev = "ffb4d0355e0da4f2781953b94217482521d3c9c3";
      fetchSubmodules = false;
      sha256 = "sha256-Pw4I3t/C457L8gPK8bVkYUaGuX9j3+uy8o28LqYUCm4=";
    };
    date = "2025-06-29";
  };
}
